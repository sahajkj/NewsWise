...
namespace NewsWise.Migrations
{
    ...
    [Migration("20230405165457_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewsWise.Models.Claim_Review", b =>
                {
                    b.HasOne("NewsWise.Models.Claim", "Claim")
                        .WithMany("Claim_Reviews")
                        .HasForeignKey("ClaimId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NewsWise.Models.Review_Publisher", "Review_Publisher")
                        .WithMany("Claim_Reviews")
